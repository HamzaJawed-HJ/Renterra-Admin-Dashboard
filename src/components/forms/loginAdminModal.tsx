...
//   // Open the modal when the user clicks anywhere on the page
//   useEffect(() => {
...
//               <Lock className="w-8 h-8 text-white" />
//             </div>
//             <h1 className="text-2xl md:text-3xl font-bold text-emerald-700 mb-1 text-center">
//               Welcome to Admin Panel of Renterra
//             </h1>
